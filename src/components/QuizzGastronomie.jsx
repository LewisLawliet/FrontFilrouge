...
class QuizzGastronomie extends React.Component {
...
state={
	...
	questionPost = (reponse) => {
		...
		fetch("http://localhost:3200/api/quizz/gastronomie/" + id, {
	...
	questionGet(libelle) {
		...
		fetch("http://localhost:3200/api/theme-quizz/gastronomie", {
	...
	render() {
        ...
        Connecte-toi pour te tester ! </p></div>)
				...
				const {questions} = this.state;		
					...
					return question.categorie === "gastronomie"			
...
export default QuizzGastronomie;