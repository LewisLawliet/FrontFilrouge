...
state={
	...
	componentDidUpdate = () => {
		...
		if(this.state.countQuestions === 8 && this.state.countGoodAnswers >=5 && this.state.countGoodAnswers < 7){
			if(this.state.gradeAppears == null )
		...
		else if(this.state.countQuestions === 8 && this.state.countGoodAnswers >=7){
			if(this.state.gradeAppears == null )
